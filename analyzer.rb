...
lines = File.readlines(ARGV[0]) #readlines("text.txt")
...
#puts text.gsub(' ', '').length
#words = text.scan(/\w+/)
#stop_words_count = text.scan(/that|and|are|or/).length
#puts "#{word_count / stop_words_count } words every words"
